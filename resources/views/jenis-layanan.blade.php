            ...
            <form class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" id="jenis" rows="4" class="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 py-2 px-3"></input>
...
<script>
    ...
    $("#crud-modal").on("click", "#simpan_perubahan", function() {
        ...
        if (id == "") {
            $.ajax({
                type: "post",
                url: "{{ route('tambah-jenis-layanan') }}",
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    jenis: jenis
                },
