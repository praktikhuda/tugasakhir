                    ...
                    <div class="px-4 py-6 sm:px-8 sm:py-7">
                        <form action="#" method="POST">
                            <div class="space-y-5">
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        <label for="" class="text-base font-medium text-gray-900 required"> Konfirmasi Password </label>
                                ...
                                <div class="text-center">
                                    <p class="text-base text-gray-600">Sudah punya akun? <a href="#" title="" class="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Masuk</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
