    ...
    <div class="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <div class="p-4 md:p-5 border-b rounded-t border-gray-200">
                ...
                <div class="col-span-2">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 required">Teknisi</label>
                    <select id="pilih_tek" class="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 py-2 px-3" name="states[]" multiple="multiple">
